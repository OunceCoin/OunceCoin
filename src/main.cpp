...
map<uint256, CBlockIndex*> mapBlockIndex;
 uint256 hashGenesisBlock("0x000008be3e87892d45121baf15b9077978956ae9666f9fbc000559963bafc279");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // OunceCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "OunceCoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000008be3e87892d45121baf15b9077978956ae9666f9fbc000559963bafc279");
    }
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("OunceCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("OunceCoinCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("OunceCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("OunceCoin-miner");
    ...
    try { loop {
        ...
        printf("Running OunceCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("OunceCoinMiner terminated\n");
        throw;
    }
}
